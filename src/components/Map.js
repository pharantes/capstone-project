...
// Toggle favorite status for a toilet
async function onToggleFavorite(toiletId, isFavorite) {
    try {
        const response = await fetch("/api/favorites", {
            ...
            body: JSON.stringify({ toiletId, isFavorite }), // You can send isFavorite if needed
            credentials: "include", // Try "include" to ensure cookies are sent
        });
